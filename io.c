...
enum { GPFSEL0 = PERIPHERAL_BASE + 0x200000, GPSET0 = PERIPHERAL_BASE + 0x20001C, GPCLR0 = PERIPHERAL_BASE + 0x200028, GPPUPPDN0 = PERIPHERAL_BASE + 0x2000E4 };
...
unsigned int uart_isOutputQueueEmpty() { return uart_output_queue_read == uart_output_queue_write; }
...
void uart_loadOutputFifo() {
  while (!uart_isOutputQueueEmpty() && uart_isWriteByteReady()) {
    ...
    uart_output_queue_read = (uart_output_queue_read + 1) & (UART_MAX_QUEUE - 1);  // Dont' overrun
  }
}
